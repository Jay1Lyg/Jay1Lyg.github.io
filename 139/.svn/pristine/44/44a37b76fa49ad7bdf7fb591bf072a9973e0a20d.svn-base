...
exports = module.exports = function (req, res) {
    ...
    if(code == undefined || appid == undefined){
        ...
        async.waterfall([
            ...
            },function(arg1,arg2,callback){//判断当前用户是否为经纪人
              BoundUserAndPublic.model.findOne()
                .where('openID', arg1.openid)
                .where('appid', arg2._id)
                .where('isSub',true)
                ...
                throw new Error(err);
                 ...
                 if(arg2.length==0){//未注册
                    console.log(arg1.openid);
                       ...
                       if(index=='1'){
                          if(is_click == true){
                               res.redirect('/agent/a_page_CrewLists/'+arg2[0].userid+'/'+arg3.appid);
                            }else{ 
                                res.redirect('/agent/a_page_actorList/'+arg2[0].userid+'/'+arg3.appid);
                            }
                         ...
                         res.redirect('/agent/a_page_actorList/'+arg2[0].userid+'/'+arg3.appid);
                            ...
                            if(is_click == true){
                             res.redirect('/agent/a_page_agent_InvitationRecords/'+arg2[0].userid);
                            }else{ 
                               res.redirect('/agent/a_page_actorList/'+arg2[0].userid+'/'+arg3.appid);
                            }
                            ...
                            if(is_click == true){
                             res.redirect('/agent/a_page_agent_applyCrewRecords/'+arg2[0].userid);
                            }else{ 
                               res.redirect('/agent/a_page_actorList/'+arg2[0].userid+'/'+arg3.appid);
                            }
                            ...
                            if(is_click == true){
                             res.redirect('/agent/a_page_actorManage/'+arg2[0].userid+'/'+arg3.appid);
                            }else{ 
                               res.redirect('/agent/a_page_actorList/'+arg2[0].userid+'/'+arg3.appid);
                            }
                            ...
                            if(is_click == true){
                              res.redirect('/agent/a_page_addNewActors/'+arg2[0].userid+'/'+arg3.appid);
                            }else{ 
                               res.redirect('/agent/a_page_actorList/'+arg2[0].userid+'/'+arg3.appid);
                            }
                            ...
                            // if(is_click == true){
                            //    res.redirect('/agent/a_page_PublicAccountsListsUderAgent/'+arg2[0].userid+'/'+arg3.appid);
                            // }else{ 
                               res.redirect('/agent/a_page_PublicAccountsListsUderAgent/'+arg2[0].userid+'/'+arg3.appid);
                            //}
