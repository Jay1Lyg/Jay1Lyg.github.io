...
exports = module.exports = function (app) {
	...
	*/  
    ...
    app.get('/WX/page_addNewActors/:userid/:appid/:index', routes.views.page_addNewActors);//新————添加新用户
    ...
    */
    ...
    app.all('/WX/uploadposterimage/:production_id/:user_id', routes.views.uploadposterimage);//上传海报(大图)
    app.all('/WX/uploadCompressposterimage/:production_id', routes.views.uploadCompressposterimage);//上传海报（缩略图）
