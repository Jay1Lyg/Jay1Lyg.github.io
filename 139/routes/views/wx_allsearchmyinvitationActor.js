...
exports = module.exports = function(req, res) {
	...
	var careerincrew_id = req.params.careerincrewid;
            ...
            if(err){
               ...
               .exec(function(err,ret){
                 if(err){
                    ...
                    positioninfo.currentPage = ret.currentPage;
                    positioninfo.totalPages = ret.totalPages;
                    async.each(ret.results,function(item,next){
                      var detail={};
                      async.waterfall([
                         function(callback){
