	...
	search.findMorePosition(careerInCrews_id, function(err,infomation){
		if(err){
            ...
            console.log(infomation);
             //console.log( infomation[0].location_name);
			res.render('page_positionDetailInfo',{
				...
				location_name : (infomation==null||infomation[0].location_name.length==0) ? '' : infomation[0].location_name[0].name,
				location_id : (infomation==null||infomation[0].location_name.length==0) ? '' : infomation[0].location_id[0],
